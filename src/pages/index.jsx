  ...
  <div className="flex md:flex-row flex-col-reverse">
    <div className="bg-gray-800 flex-1 flex items-center justify-center p-4 sm:p-8 text-white">
      <div>
        ...
        <P>
          At Mikal Howard Finance, we help guide and educate people through the complexities
          of applying for finance to buy a home to live in or build an investment property
          portfolio, based on your personal situation and goals.
        </P>
        <Link href="/enquire" passHref>
          <button type="button" className="rounded mt-4 px-4 py-2 bg-red-400 hover:bg-red-600 text-white">Enquire Now</button>
        </Link>
      </div>
    </div>
    <div className="flex-1 bg-gray-800">
      <div className="">
        <img className="object-contain h-full w-full" height="650" width="689" style={{ maxHeight: '650px' }} src="images/Mikal17-optim.jpg" alt="Mikal from Mikal Howard Finance standing in front of a wooden feature background" />
      </div>
    </div>
  </div>
);
...
const Index = () => (
  <div className="relative">
    ...
    <ContentSection
      className=""
      left
      image={<img width="2500" height="1668" src="images/bg-showcase-2.jpg" alt="Couple being handed some keys to their new home" />}
    >
      <H2>Move into your dream home</H2>
      <P>
        Going through the process of securing a home loan can be daunting, let us make
        it easy for you. Whether it&apos;s your first home or a big move, our personalised
        approach will ensure you receive the best rate for your financial situation.
      </P>
    </ContentSection>
    <ContentSection
      className=""
      left={false}
      image={<img width="1920" height="1280" src="images/old-3608950_1920.jpg" alt="Older couple walking along the beach" />}
    >
      <H2>Grow your business</H2>
      <P>
        Let us take the stress out of the entire loan process, so you can spend
        more time and energy working in your business or on your next big idea!
      </P>
    </ContentSection>
    <ContentSection
      className=""
      left
      image={<img width="1909" height="1400" src="images/Mikal20-optim.webp" alt="Mikal Howard from Mikal Howard Finance sitting down looking at the camera" />}
    >
    ...
    <Section className="bg-gray-900 text-white flex justify-center items-center">
      <div className="md:w-10/12 lg:w-2/3">
        ...
        <p className="text-md leading-relaxed">
          ...
          <a className="underline hover:text-red-600" href="https://www.facebook.com/MikalHowardFinance/reviews/" target="_blank" rel="noreferrer">facebook page</a>
        </p>
      </div>
    </Section>
