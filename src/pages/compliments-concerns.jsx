...
const ComplimentsConcerns = () => (
	<div>
		...
		<Section className="lg:w-10/12 m-auto">
			...
			<P className="my-8">You can lodge your complaint with the <strong>Credit and Investments Ombudsman</strong> if lodged before 1st November 2018:<br />
			Online: www.cio.org.au<br />
			Email: info@cio.org.au<br />
			Phone: 1800 138 422 (free call)<br />
			Mail: Credit and Investments Ombudsman Reply Paid 252, South Sydney NSW 1234</P>
			<P className="my-8">or with the <strong>Australian Financial Complaints Authority</strong> if lodged on or after 1st November 2018:<br />
			Online: www.afca.org.au<br />
			Email: info@afca.org.au<br />
			Phone: 1800 931 678 (free call)<br />
			Mail: Australian Financial Complaints Authority GPO Box 3, Melbourne VIC 3001</P>
		</Section>
		<Footer/>
	</div>
)
