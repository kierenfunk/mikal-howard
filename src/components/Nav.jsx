...
const Nav = () => {
  ...
  return (
    <>
      ...
      <div className="sticky top-0 z-20">
        <div className="py-2 px-6 bg-white flex justify-between">
          <div className="flex justify-center items-center">
            <Link href="/" passHref>
              <button type="button"><img width="1897" height="1085" className="w-24" src="images/logo.png" alt="Mikal Howard Finance Logo" /></button>
            </Link>
          </div>
      ...
      <div className={`${open ? 'bg-opacity-75 visible' : 'bg-opacity-0 invisible'} fixed top-0 left-0 transition-all duration-700 w-screen h-screen z-0 bg-black md:hidden`} />
